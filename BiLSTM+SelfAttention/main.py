...
def main():
    ...
    #初始化模型
    net = BiLSTMSelfAttention(vocab_size, config["embedding_dim"], config["hidden_dim"],config["num_heads"],config["bidirectional"], config["n_layers"], config["output_dim"], config["dropout"],
